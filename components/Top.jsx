...
export default function Top() {
  ...
  return (
    <div
      className="text-white text-center flex flex-col items-center justify-center p-2 bg-primary w-screen h-screen lg:py-10
        "
    >
      ...
      >
        <div className="font-semibold text-3xl">{t("name")}</div>
        <div className="text-gray-300 text-lg pt-2 font-medium">
          {t("nameDesc")}
        </div>
        <div className="w-3/4 text-gray-300">{t("subDesc")}</div>
        <a
          target="_blank"
